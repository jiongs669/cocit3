...
import static com.cocit.api.APIConst.ORDER_BZUDF_FIELD;
import static com.cocit.biz.BizConst.TYPE_BZFORM_EDIT_N;
...
public class AbstractSystemData extends NamedEntity implements IFieldDefinition {
	...
	public void setType(IFieldDataType type) {
	...
	@Override
	public IFieldDefinition getRefrenceField() {
	...
	public void setUiTemplate(String v) {
		uiTemplate = v;
	}
	...
	public void setRegexpMask(String v) {
		regexpMask = v;
	}
	...
	public void setUopOptions(String v) {
		uomOptions = v;
	}
	...
	public void setUopOption(String v) {
		uomOption = v;
	}
	...
	public boolean isMapping() {
		return mapping && this.getRefrenceSystem() != null && this.getRefrenceData() == null;
	}
