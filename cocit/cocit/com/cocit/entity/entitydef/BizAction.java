package com.cocit.entity.entitydef;

import static com.cocit.api.APIConst.BIZCATA_UDF_CONSOLE;
...
import static com.cocit.api.APIConst.ORDER_BZUDF_ACTION;
...
import com.cocit.entity.security.BaseAction;
...
public class BizAction extends BaseAction implements IEntityAction {
	@ManyToOne
	...
	public void setActionLib(ActionDefinition refAction) {
		this.actionDefinition = refAction;
	}

	public Integer getTypeCode() {
		if ((super.getTypeCode() == null || super.getTypeCode() <= 0) && getActionDefinition() != null) {
			return getActionDefinition().getTypeCode();
		}
		return super.getTypeCode();
	}

	public String getMode() {
		if (Str.isEmpty(super.getMode()) && getActionDefinition() != null) {
			return getActionDefinition().getMode();
		}
		return super.getMode();
	}

	public String getTemplate() {
		if (Str.isEmpty(super.getTemplate()) && getActionDefinition() != null) {
			return getActionDefinition().getTemplate();
		}
		return super.getTemplate();
	}

	public String getPlugin() {
		if (Str.isEmpty(super.getPlugin()) && getActionDefinition() != null) {
			return getActionDefinition().getPlugin();
		}
		return super.getPlugin();
	}

	public Upload getLogo() {
		if (Str.isEmpty(logo == null ? null : logo.toString()) && getActionDefinition() != null) {
			return getActionDefinition().getLogo();
		}
		return super.getLogo();
	}

	public Upload getImage() {
		if (Str.isEmpty(image == null ? null : image.toString()) && getActionDefinition() != null) {
			return getActionDefinition().getImage();
		}
	...
	public void setSystem(IEntityDefinition system) {
	...
	public String getParams() {
		if (Str.isEmpty(super.getParams()) && getActionDefinition() != null)
			return getActionDefinition().getParams();

		return params;
	}

	public String getTargetWindow() {
		if (Str.isEmpty(super.getTargetWindow()) && getActionDefinition() != null)
			return getActionDefinition().getTargetWindow();
