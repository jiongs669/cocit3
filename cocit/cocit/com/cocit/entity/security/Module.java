...
import static com.cocit.api.APIConst.ORDER_SYSADMIN_MODULE;
...
public class Module extends NamedEntity implements IModule<Module> {
	@ManyToOne
	...
	public void setRefSystem(IEntityDefinition system) {
		...
		if (system != null) {
			IEntityDefinition sys = entityDefEngine.getSystem(system.getId());
			if (sys != null) {
	...
	public String getRefName() {
		switch (type) {
		case TYPE_BIZ:
			return entityDefEngine.getSystem(refSystem.getId()).getName();
