package com.jiongsoft.cocit.engine;

import static com.cocit.api.APIConst.F_CODE;
import static com.cocit.api.APIConst.F_MODE;
import static com.cocit.api.APIConst.F_PROP_NAME;
import static com.cocit.api.APIConst.F_SYSTEM;
import static com.cocit.api.APIConst.F_TYPE_CODE;
...
import com.cocit.entity.dic.Dic;
import com.cocit.entity.dic.DicCategory;
import com.cocit.entity.entitydef.AbstractSystemData;
import com.cocit.entity.entitydef.ActionDefinition;
import com.cocit.entity.entitydef.BizAction;
import com.cocit.entity.entitydef.BizCatalog;
import com.cocit.entity.entitydef.SFTSystem;
import com.cocit.entity.entitydef.SystemDataGroup;
import com.cocit.entity.entitydef.SystemDataType;
...
public class SFTBizEngine extends BizEngine {
	...
	protected boolean isMappingToMaster(IFieldDefinition fld) {
		AbstractSystemData data = (AbstractSystemData) fld;
		return data.isMappingToMaster() || data.isMapping();
	}

	public boolean isGridField(IFieldDefinition fld) {
		AbstractSystemData data = (AbstractSystemData) fld;
	...
	private IEntityDefinition setupSystemFromClass(String soft, Class klass, boolean autoUpdate) throws DemsyException {
		...
		List<IFieldDefinition> newFields = new LinkedList();
	...
	public IFieldDefinition parseBizField(String soft, Mirror entityObj, String fldProp, IEntityDefinition bzSystem, IFieldDefinition oldBzField) {
		Map<String, IFieldDataType> fieldLibs = this.getFieldTypes();
	...
	public List<? extends IFieldDefinition> makeFields(IRuntimeField runtimeCustom) {
