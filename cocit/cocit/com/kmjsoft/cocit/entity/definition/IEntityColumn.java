...
public interface IEntityColumn extends INamedEntity {
	...
	/**
	 * 实体定义：逻辑外键，关联到“{@link IEntityDefinition#getDataGuid()}”字段。
	 * <p>
	...
	void setDefinitionGuid(String definitionGuid);
	...
	/**
	 * 外键实体：逻辑外键，关联到“{@link IEntityDefinition#getDataGuid()}”字段。
	 * <p>
	 * 
	 * 
	 * @return
	 */
	String getFkDefinitionGuid();

	void setFkDefinitionGuid(String fkDefinitionGuid);
	...
	void setFkEntityFieldGuid(String enittyFieldGuid);
