 ...
 * @author yongshan.ji
 */
public interface IEntityField extends INamedEntity {
	...
	/**
	 * 实体定义：逻辑外键字段。关联到“{@link IEntityDefinition#getDataGuid()}”字段。
	 * 
	 * @return
	 */
	String getEntityDefinitionGuid();

	/**
	 * 字段分组：逻辑外键字段。关联到“{@link IFieldGroup#getDataGuid()}”字段。
	 * 
	 * @return
	 */
	String getFieldGroupGuid();

	/**
	 * 字段数据类型：可选值参见“{@link IEntityField#DATA_TYPE_XXXXX}”值。
	 * 
	 * @return
	 */
	byte getFieldDataType();
	...
	/**
	 * 此“外键字段”关联到哪个实体？逻辑外键字段。关联到“{@link IEntityDefinition#getDataGuid()}”字段。
	 * 
	 * @return
	 */
	String getFKEntityDifinitionGuid();
	...
	void setType(IFieldDataType fieldDataType);
