...
public class EntityColumn extends NamedEntity implements IEntityColumn {
	...
	@ManyToOne
	private String fkDefinitionGuid;// “系统引用”类型——所引用的系统

	@ManyToOne
	private String fkEntityFieldGuid;// “字段引用”类型——所引用的系统字段
	...
	public String getFkDefinitionGuid() {
		return fkDefinitionGuid;
	}

	public void setFkDefinitionGuid(String fkDefinitionGuid) {
		this.fkDefinitionGuid = fkDefinitionGuid;
	}

	public String getFkEntityFieldGuid() {
		return fkEntityFieldGuid;
	}

	public void setFkEntityFieldGuid(String fkEntityFieldGuid) {
		this.fkEntityFieldGuid = fkEntityFieldGuid;
	}
