...
import com.kmjsoft.cocit.actionplugin.module.ModulePlugins;
...
, actions = {
//
		@CocAction(name = "定制系统", type = 9101, mode = "bc", targetWindow = "_blank", pageTemplate = "/system/AddSystem.jsp", plugin = ModulePlugins.AddModules.class)//
		, @CocAction(name = "添加", type = 101, mode = "b", plugin = ModulePlugins.AddModule.class)//
		, @CocAction(name = "编辑", type = TYPE_BZFORM_EDIT, mode = "e", plugin = ModulePlugins.EditModule.class) //
...
public class EntityModule extends NamedEntity implements IEntityModule {
	...
	public void setCatalogGuid(String entityCatalogGuid) {
		this.catalogGuid = entityCatalogGuid;
	}
