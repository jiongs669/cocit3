...
import com.kmjsoft.cocit.entity.security.IUserGroup;
...
public class UserGroup extends DataEntity implements IUserGroup {
	...
	public void setGroupGuid(String roleGuid) {
		this.groupGuid = roleGuid;
	}
