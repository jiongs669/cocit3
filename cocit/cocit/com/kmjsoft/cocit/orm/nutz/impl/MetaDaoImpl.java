...
import com.kmjsoft.cocit.orm.metadata.ColumnMetadata;
import com.kmjsoft.cocit.orm.metadata.DatabaseMetadata;
import com.kmjsoft.cocit.orm.metadata.ForeignKeyMetadata;
import com.kmjsoft.cocit.orm.metadata.TableMetadata;
...
public class MetaDaoImpl implements DMLSession {
	...
	protected String toSqlType(String srcType, int l, int p, int s) {
		...
		try {
			...
			CocColumn bzfld = (CocColumn) cls.getAnnotation(CocColumn.class);
