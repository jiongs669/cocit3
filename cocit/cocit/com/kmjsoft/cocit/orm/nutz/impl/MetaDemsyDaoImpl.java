...
import com.kmjsoft.cocit.orm.DMLSession;
import com.kmjsoft.cocit.orm.NoTransConnCallback;
import com.kmjsoft.cocit.orm.dialect.Dialect;
import com.kmjsoft.cocit.orm.dialect.impl.SqlServerDialect;
...
import com.kmjsoft.cocit.orm.nutz.SaveManyInvoker;
import com.kmjsoft.cocit.orm.nutz.SaveManyManyInvoker;
import com.kmjsoft.cocit.orm.nutz.intercepter.ManyFieldGetterIntercepter;
import com.kmjsoft.cocit.orm.nutz.intercepter.OneFieldGetterIntercepter;
...
public class MetaDemsyDaoImpl extends DemsyNutzDao implements IExtDao {
	...
	private void syncTable(EnMappingImpl entity, boolean syncRefTable) {
		...
		getDMLSession().syncTables(entity, syncRefTable);
	}
	...
	private void syncRefTable(EnMappingImpl entity) {
		...
		getDMLSession().syncTables(entity, true);
	}
