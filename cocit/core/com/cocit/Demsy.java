...
import com.cocit.actions.BizActions;
import com.cocit.actions.ConfigActions;
import com.cocit.actions.IndexActions;
import com.cocit.actions.SecurityActions;
import com.cocit.actions.UiActions;
import com.cocit.actions.UploadActions;
import com.cocit.api.IEntityDefEngine;
import com.cocit.api.IModuleEngine;
import com.cocit.api.IUIEngine;
import com.cocit.api.security.IAdminUser;
import com.cocit.api.security.ITenant;
import com.cocit.api.security.IUser;
import com.cocit.biz.IBizManagerFactory;
import com.cocit.biz.IBizSession;
import com.cocit.config.IAppConfig;
import com.cocit.config.IDatasourceConfig;
import com.cocit.config.impl.AppConfig;
import com.cocit.config.impl.DbConfig;
import com.cocit.config.impl.LogConfig;
import com.cocit.ctx.IIoc;
import com.cocit.ctx.IocLoader;
import com.cocit.lang.Assert;
import com.cocit.lang.ConfigException;
import com.cocit.lang.DemsyException;
import com.cocit.lang.Lists;
import com.cocit.lang.Str;
import com.cocit.log.Log;
import com.cocit.log.Logs;
import com.cocit.mvc.MvcConst;
import com.cocit.mvc.nutz.DemsyActionHandler;
import com.cocit.mvc.nutz.DemsyAdaptor;
import com.cocit.mvc.nutz.DemsyIocProvider;
import com.cocit.mvc.nutz.DemsyLoading;
import com.cocit.mvc.nutz.DemsyNutConfig;
import com.cocit.mvc.nutz.DemsySetup;
import com.cocit.mvc.nutz.DemsyUrlMappingImpl;
import com.cocit.mvc.render.DataRender;
import com.cocit.mvc.render.ViewRender;
import com.cocit.mvc.template.ITemplateEngine;
import com.cocit.mvc.template.SmartyTemplate;
import com.cocit.mvc.view.DemsyViewMaker;
import com.cocit.orm.IOrm;
import com.cocit.orm.generator.INamingStrategy;
import com.cocit.orm.generator.impl.EncodeNamingStrategy;
import com.cocit.orm.listener.EntityListeners;
import com.cocit.orm.nutz.EnMappingHolder;
import com.cocit.orm.nutz.EnMappingMaker;
import com.cocit.orm.nutz.impl.DemsyTransaction;
import com.cocit.orm.nutz.impl.OrmImpl;
import com.cocit.security.ILogin;
import com.cocit.security.ISecurity;
import com.cocit.security.SecurityException;
...
public abstract class Demsy implements Const, MvcConst {
	...
	private static Map<IDatasourceConfig, IOrm> ormMap = new HashMap();
	...
	public static IEntityDefEngine entityDefEngine;
	...
	private static void init() {
		...
		Assert.notNull(entityDefEngine = bean("bizEngine"));
	 ...
	 * @return
	 */
	public static IOrm orm(IDatasourceConfig db) {
		synchronized (ormMap) {
	 ...
	 * <LI>已登录：
	 * <UL>
	 * <LI>登录信息中的用户实体未过期：则获取登录信息中的用户实体 {@link com.cocit.security.ILogin#getUser()}；
	 ...
	 * @return
	 */
	public abstract ITenant getSoft();
