 ...
 * @author yongshan.ji
 */
public interface IFieldDefinition extends INamedEntity {
	 ...
	 * @return
	 */
	IEntityDefinition getRefrenceSystem();
	 ...
	 * @return
	 */
	IFieldDefinition getRefrenceField();

	String getRefrenceFields();

	IFieldDefinition getParent();
