...
public abstract class Lists {
	...
	public static List<String> enum2list(Enumeration<?> enums) {
	...
	public static List<String> iterator2list(Iterator<?> enums) {
		LinkedList<String> re = new LinkedList<String>();
		while (enums.hasNext())
	 ...
	 * @see Obj#toArray(Object)
	 */
	public static List arrayToList(Object source) {
		return Arrays.asList(Obj.toArray(source));
	}
	...
	public static boolean contains(Iterator iterator, Object element) {
		if (iterator != null) {
			while (iterator.hasNext()) {
				...
				if (Obj.equals(candidate, element)) {
					return true;
				}
			}
		}
	...
	public static Object findValueOfType(Collection collection, Class[] types) {
		if (isEmpty(collection) || Obj.isEmpty(types)) {
			return null;
		}
