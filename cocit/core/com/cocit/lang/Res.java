...
public abstract class Res {
	...
	public static URL getURL(String resourceLocation) throws FileNotFoundException {
		...
		if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
			...
			URL url = Cls.getDefaultClassLoader().getResource(path);
			if (url == null) {
	...
	public static boolean isJarURL(URL url) {
		...
		return (URL_PROTOCOL_JAR.equals(protocol) || URL_PROTOCOL_ZIP.equals(protocol) || URL_PROTOCOL_WSJAR.equals(protocol) || (URL_PROTOCOL_CODE_SOURCE.equals(protocol) && url.getPath().indexOf(
				JAR_URL_SEPARATOR) != -1));
	}
	...
	public static URI toURI(String location) throws URISyntaxException {
		return new URI(Str.replace(location, " ", "%20"));
	}
