package com.cocit.mvc.ui.widget;
...
import com.cocit.mvc.ui.model.UITabsModel;
import com.cocit.mvc.ui.widget.menu.UIButtonMenu;
import com.cocit.mvc.ui.widget.menu.UIContextMenu;
 ...
 * 
 */
public class UIBizModule extends UIWidget {

	private UITabsModel master;

	private UITabsModel slave;
	...
	public UIBizModule(Map ctx, Serializable id) {
		super(ctx, id);
	}
	...
	public UITabsModel getSlave() {
		return slave;
	}

	public void setSlave(UITabsModel slaveModel) {
		this.slave = slaveModel;
	}

	public UITabsModel getMaster() {
		return master;
	}

	public void setMaster(UITabsModel master) {
		this.master = master;
	}
}