package com.cocit.orm.nutz.impl;
...
import com.cocit.ctx.aop.LazyClassAgent;
import com.cocit.ctx.aop.asm.DemsyAsmClassAgent;
import com.cocit.ctx.aop.asm.LazyAsmClassAgent;
...
import com.cocit.orm.IMetaDao;
import com.cocit.orm.NoTransConnCallback;
import com.cocit.orm.dialect.Dialect;
import com.cocit.orm.dialect.impl.SqlServerDialect;
import com.cocit.orm.generator.INamingStrategy;
import com.cocit.orm.listener.EntityListeners;
import com.cocit.orm.mapping.EnColumnMapping;
import com.cocit.orm.mapping.EnMapping;
import com.cocit.orm.nutz.EnColumnMappingImpl;
...
import com.cocit.orm.nutz.SaveManyInvoker;
import com.cocit.orm.nutz.SaveManyManyInvoker;
import com.cocit.orm.nutz.intercepter.ManyFieldGetterIntercepter;
import com.cocit.orm.nutz.intercepter.OneFieldGetterIntercepter;
...
public class MetaDemsyDaoImpl extends DemsyNutzDao implements IExtDao {
	...
	private <T> EnMappingImpl<T> loadEntity(Class<T> classOfT, boolean syncTable, boolean syncRefTable) {
		...
		if (entity != null) {
			...
			// 加载子类实体
			List<Class<?>> list = entityDefEngine.listTypes();
			if (list != null) {
				for (Class cls : list) {
