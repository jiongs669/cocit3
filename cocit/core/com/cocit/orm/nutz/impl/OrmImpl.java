...
public class OrmImpl implements IOrm {
	...
	public OrmImpl(IDatasourceConfig config, EnMappingHolder holder, EnMappingMaker maker, EntityListeners listeners) {
		try {
	...
	protected DataSource getComboPooledDataSource(IDatasourceConfig config) {
