...
public class AntPathMatcher implements PathMatcher {
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch) {
		...
		String[] pattDirs = Str.toArray(pattern, this.pathSeparator);
		String[] pathDirs = Str.toArray(path, this.pathSeparator);
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = Str.toArray(pattern, this.pathSeparator);
		String[] pathParts = Str.toArray(path, this.pathSeparator);
