...
import com.jiongsoft.cocit.orm.generator.impl.EncodeNamingStrategy;
...
import com.jiongsoft.cocit.orm.nutz.impl.DemsyTransaction;
...
public abstract class Demsy implements Const, MvcConst {
	 ...
	 * @return
	 */
	public abstract ISystemTenant getSoft();
	...
	private static class WebDemsy extends Demsy {
		...
		private void initInvoker() throws SecurityException {
			...
			// 路径的第一个节点不是应用编号
			try {
				soft = moduleManager.getSoft(domain);
