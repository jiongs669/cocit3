package com.jiongsoft.cocit.modules.webmail.spi;

public final class Constants {

	public static final String MESSAGE_CHAR_ENCODING = "UTF-8";

	public static final String PROPERTIES_FILE_APPLICATION = "com/kmetop/demsy/webmail/properties/application.properties";

	public static final String PROPERTIES_FILE_LOGON = "com/kmetop/demsy/webmail/properties/logon.properties";

	public static final String PROPERTIES_FILE_SMTP = "com/kmetop/demsy/webmail/properties/smtp.properties";
	...
	//
	// public static final String NAME_MBEAN_FOLDERWRAPPER =
	// "folderWrapperBean";
	//
	// public static final String NAME_MBEAN_FOLDERMANAGEMENT =
	// "folderManagementBean";
	//
	// public static final String NAME_MBEAN_DISPLAYMESSAGE =
	// "displayMessageBean";
	//
	// public static final String NAME_MBEAN_SMTPCONNECTION =
	// "smtpConnectionBean";
	//
	...
	// public static final String CLIENT_ID_MAILBOXHOST =
	// "logonForm:mailboxHost";
	//
	// /** Client-ID der Mailbox-User-Komponente */
	// public static final String CLIENT_ID_MAILBOXUSER =
	// "logonForm:mailboxUser";
	//
	...
	// public static final String CLIENT_ID_SMTPHOST =
	// "createMailForm:smtpHost";
	//
