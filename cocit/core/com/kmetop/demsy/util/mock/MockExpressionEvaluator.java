...
public class MockExpressionEvaluator extends ExpressionEvaluator {
	...
	public Expression parseExpression(final String expression, final Class expectedType, final FunctionMapper functionMapper) throws ELException {
	...
	protected Object doEvaluate(String expression, Class expectedType, FunctionMapper functionMapper) throws ELException {
		...
		// try {
		// return ExpressionEvaluatorManager.evaluate("JSP EL expression",
		// expression, expectedType, this.pageContext);
		// }
		// catch (JspException ex) {
		throw new ELException("Parsing of JSP EL expression \"" + expression + "\" failed");
		// }
	}
