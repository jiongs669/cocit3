...
public class MockPageContext extends PageContext {
	 ...
	 *            the ServletContext that the JSP page runs in (only necessary
	 *            when actually accessing the ServletContext)
	 */
	 ...
	 * @param request
	 *            the current HttpServletRequest (only necessary when actually
	 ...
	 * @param response
	 *            the current HttpServletResponse (only necessary when actually
