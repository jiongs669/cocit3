package com.kmetop.demsy.util.mock;
...
import com.kmetop.demsy.util.WebUtils;
import com.kmetop.demsy.util.io.DefaultResourceLoader;
import com.kmetop.demsy.util.io.Resource;
import com.kmetop.demsy.util.io.ResourceLoader;
 ...
 * FileSystemXmlApplicationContext can be used to load the context files for
 * testing, even for DispatcherServlet context definitions.
 * 
 * <p>
 ...
 * both FileSystemXmlApplicationContext (which will load straight from the file
 * system) and XmlWebApplicationContext with an underlying MockServletContext
 * (as long as the MockServletContext has been configured with a
 * FileSystemResourceLoader).
 * 
 * @author Rod Johnson
 * @author Juergen Hoeller
 * @since 1.0.2
 * @see #MockServletContext(com.kmetop.demsy.util.io.ResourceLoader)
...
public class MockServletContext implements ServletContext {
	 ...
	 * 
	 * @see com.kmetop.demsy.util.io.DefaultResourceLoader
	 */
	...
	/**
	 * Create a new MockServletContext, using the specified ResourceLoader and
	 * no base path.
	 * 
	 ...
	 * resource base path of this MockServletContext.
	 * 
	 * @param path
