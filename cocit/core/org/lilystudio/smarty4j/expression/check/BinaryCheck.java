...
public abstract class BinaryCheck extends BinaryCheckExpression {
	...
	public static boolean isNumeric(Object o) {
		if ((o != null) && !(o instanceof Number) && !(Str.isEmpty(o.toString()))) {//DEMSY FIXED			
			String s = o.toString();
	...
	public static double o2d(Object o) {
		if (o == null || Str.isEmpty(o.toString())) {// DEMSY FIXED
			return 0.0d;
	...
	public void parse(MethodVisitor mw, int local, Map<String, Integer> variableNames) {
		...
		if (exp1IsNumber && exp2IsNumber) {
			...
			mw.visitMethodInsn(INVOKESTATIC, NAME, "isNumeric", "(Ljava/lang/Object;)Z");
			...
			mw.visitMethodInsn(INVOKESTATIC, NAME, "o2s", "(Ljava/lang/Object;)Ljava/lang/String;");
