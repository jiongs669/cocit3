	...
	public void execute(Context context, Writer writer, Object[] values) throws Exception {
		if (values[3] != null) {
			if (values[1] == null) {
				...
				context.set((String) values[3], Str.encodeUri(Obj.getStringValue(values[0], (String) values[1], (String) values[2])));
		} else {
			if (values[1] == null) {
				writer.write(Str.encodeUri(values[0]));
			} else {
				writer.write(Str.encodeUri(Obj.getStringValue(values[0], (String) values[1], (String) values[2])));
			}
		}
	}
